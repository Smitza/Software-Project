...
INSERT INTO `billing_information` (`userId`, `Addressline1`, `Addressline2`) VALUES
    (9, 'tst', 'test');
...
INSERT INTO `delivery` (`deliveryid`, `userid`, `deliverydate`, `status`) VALUES
                                                                              ...
                                                                              (20, 0, NULL, 'Pending'),
                                                                              (21, 1, NULL, 'Pending'),
                                                                              (22, 1, NULL, 'In Transit'),
                                                                              (23, 1, NULL, 'Pending'),
                                                                              (24, 1, NULL, 'Pending'),
                                                                              (25, 1, NULL, 'Pending'),
                                                                              (26, 1, NULL, 'Pending'),
                                                                              (27, 1, '2024-05-01', 'Pending'),
                                                                              (28, 10, '2024-05-01', 'Pending'),
                                                                              (29, 10, '2024-05-01', 'Pending');
...
INSERT INTO `payment` (`payid`, `userid`, `amount`, `paymentdate`, `paymentmethod`) VALUES
                                                                                        (1, 4, 55, '2024-05-01 14:03:05', 'Credit Card'),
                                                                                        (2, 9, 50, '2024-05-01 14:50:32', 'Credit Card');
...
INSERT INTO `products_users` (`id`, `userid`, `productid`, `quantity`, `orderdate`) VALUES
                                                                                        (18, 9, 1, 1, '2024-04-28'),
                                                                                        (19, 9, 1, 1, '2024-04-28'),
                                                                                        (20, 9, 3, 1, '2024-04-28'),
                                                                                        (21, 9, 2, 1, '2024-04-28'),
...
--
-- Triggers `products_users`
--
DROP TRIGGER IF EXISTS `Assign_Delivery`;
DELIMITER $$
CREATE TRIGGER `Assign_Delivery` AFTER INSERT ON `products_users` FOR EACH ROW BEGIN
    DECLARE deliverer_id INT;

    SELECT userid INTO deliverer_id
    FROM users
    WHERE isDeliverer = 1
    ORDER BY RAND()
    LIMIT 1;

    INSERT INTO delivery (deliveryid, userid, deliverydate, status)
    VALUES (NEW.id, deliverer_id, NOW(), 'Pending');
END
$$
DELIMITER ;
...
INSERT INTO `tvshows` (`tvid`, `showrunner`, `format`, `noofseasons`, `noofepisodes`, `runtime`, `tvrating`) VALUES
                                                                                                                 (1, 'Vince Gilligan', 'Streaming', 5, 62, '45 minutes', 'TV-MA'),
                                                                                                                 (2, 'David Benioff', 'DVD', 8, 73, '60 minutes', 'TV-14'),
                                                                                                                 (3, 'Duffer Brothers', 'Streaming', 3, 25, '50 minutes', 'TV-14'),
                                                                                                                 (4, 'Shonda Rhimes', 'Streaming', 6, 112, '55 minutes', 'TV-14'),
                                                                                                                 (5, 'Matthew Weiner', 'DVD', 7, 92, '47 minutes', 'TV-MA');
...
CREATE TABLE `users` (
                         ...
                         `isDeliverer` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`userid`, `username`, `email`, `password`, `phone`, `name`, `membership`, `isAdmin`, `isDeliverer`) VALUES
                                                                                                                             (1, 'user1', 'user1@example.com', '$2a$10$D6C9jRdaQVV6JYY1Bv7jwOBMqgrRICUp1bTsZIBrO8IUyyK2v7G4y', '123456789', 'User One', 1, 0, 1),
                                                                                                                             (2, 'user2', 'user2@example.com', '$2a$10$mBaFu5RTtL6hYfTFB08SfuwrSt4rSPRACey8d/RQXgloiq.eLcyPy', '987654321', 'User Two', 2, 0, 0),
                                                                                                                             (3, 'admin', 'admin@example.com', '$2a$10$YYLoNAifKuitaOjg9CNghu86FdqHNlXZyw.azxdlvN00SJqHkEf4e', '111222333', 'Admin User', 3, 1, 0),
                                                                                                                             (4, 'john_doe', 'john.doe@example.com', '$2a$10$7K4J0N1rztfc1dPZ7wx/w.vajQUY/BdOpkxMCx4RFUGEEX7TGjqKC', '555666777', 'John Doe', 1, 0, 0),
                                                                                                                             (5, 'jane_doe', 'jane.doe@example.com', '$2a$10$YKC7XIYDlTVXpedc/kuTK.DB.cXLo9o2PMR42F6smkqm2p/KRQkVe', '999888777', 'Jane Doe', 2, 0, 0),
                                                                                                                             (6, 'Zach', 'zach@yahoo.ie', '$2a$10$jCUpZ9pN3jV5YQuA7vQA8eXPB/TRC2ulipvro4jvuQn9/FsCXUpbu', '0892102298', 'Zach Affron', 1, 1, 0),
                                                                                                                             (7, 'Test', 'test@hello.com', '$2a$10$JyLOXENxuKZtlb66yaAHIu2WVRkhmq/IQECi.f.Pw86hA2gGXiNMO', '086273823', 'Test Person', 1, 0, 0),
                                                                                                                             (8, 'Danchuck', 'danchuck@Meshi.com', '$2a$10$ezlqHnYEc2FXOTTwxPJXBeVbz9ZgLbGKuFnlT5HUDJmzzrP69yOia', '1', 'Danchuck', 1, 1, 0),
                                                                                                                             (9, 'Leo', 'Leo@Gay.com', '$2a$10$s/catfg0GXwSjn4AtTytxuTDLNrEXy7UkXeGSSsoQVCN5z1uIREmy', '0987654321', 'leo lion', 3, 0, 0),
                                                                                                                             (10, 'Napoleon', 'Nap@yahoo.com', '$2a$10$lattvwYP57FnoJ6WvKjA/ePSSPMXC4Opgb2J56YDib0wvEewxfYZy', '0987654321', 'Napoleon', 1, 0, 1),
                                                                                                                             (11, 'FinalTest', 'FinalTest@email.com', '$2a$10$.NOPOAdU6QM2NObpFCscueR4dgV96uvP2iZaX8NiHTJdvzg2xX/oK', '0987654321', 'Final Test', 1, 0, 0);
...
--
ALTER TABLE `delivery`
    MODIFY `deliveryid` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `billing_information`
    ADD CONSTRAINT `billing_information_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userid`);
...
--
ALTER TABLE `products_users`
    ADD CONSTRAINT `products_users_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`);
COMMIT;
