            ...
            <section class="">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <p><i class="fas fa-home mr-3"></i>Dunstitute of Technology, Dublin Rd, Marshes Upper, Dundalk, Co. Louth, A91 K584</p>
                        <p><i class="fas fa-envelope mr-3"></i> helpdesk@dkit.ie</p>
                        <p><i class="fas fa-phone mr-3"></i> +353-0429370300</p>
                        <p><i class="fas fa-print mr-3"></i> +353-0429370300</p>
                    </div>
