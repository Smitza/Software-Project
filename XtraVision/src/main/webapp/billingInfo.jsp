...
<form  action="controller" method="post">
    ...
    <input type="text" id="address1" name="address1" value="" required><br><br>

    <label for="address2">Address Line 2:</label>
    <input type="text" id="address2" name="address2" value="" required><br><br>

    <label for="phonenumber">phonenumber:</label>
    <input type="number" id="phonenumber" name="phonenumber" required><br><br>

    <label for="cardNumber">Card Number:</label>
    <input type="number" id="cardNumber" name="cardNumber" value="" required><br><br>

    <label for="cardHolder">Card Holder:</label>
    <input type="text" id="cardHolder" name="cardHolder" value="" required><br><br>

<%--    took this from stackOverflow - https://stackoverflow.com/questions/17017136/how-to-format-credit-card-input-fields-and-expiry-date ---%>
...
<script>
    ...
    <input type="number" id="secNumb" name="secNumb" value="" required><br><br>
